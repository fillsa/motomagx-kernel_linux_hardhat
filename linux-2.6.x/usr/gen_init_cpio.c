 ...
 *
 * Date         Author          Comment
 * 10/2006      Motorola        Removed timestamps for modificaiton times in
 *				the cpio of the kernel in order to make
 *				checksum generation possible for comparison of 
 *				kernel builds
 */
...
#include <string.h>
#include <unistd.h>
/* CONFIG_MOT_FEAT_CHKSUM is ignored here */
/* #include <time.h> */
#include <fcntl.h>
#include <errno.h>
#include <ctype.h>
