...
extern int pnx4008_gpio_register_pin(unsigned short key);
extern int pnx4008_gpio_unregister_pin(unsigned short key);
extern unsigned long pnx4008_gpio_read_pin(unsigned short key);
extern int pnx4008_gpio_write_pin(unsigned short key, int output);
extern int pnx4008_gpio_set_pin_direction(unsigned short key, int output);
extern int pnx4008_gpio_read_pin_direction(unsigned short key);
extern int pnx4008_gpio_set_pin_mux(unsigned short key, int output);
extern int pnx4008_gpio_read_pin_mux(unsigned short key);
