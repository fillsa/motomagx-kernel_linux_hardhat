 ...
 *
 * Date     Author    Comment
 * 10/2006  Motorola  Added a WFN #define for EPIT1_AP_BASE_ADDR
 */
...
#define IOMUX_TO_GPIO(pin) 	(((pin >> MUX_IO_P) * GPIO_NUM_PIN) + ((pin >> MUX_IO_I) & ((1 << (MUX_IO_P - MUX_IO_I)) -1)))
