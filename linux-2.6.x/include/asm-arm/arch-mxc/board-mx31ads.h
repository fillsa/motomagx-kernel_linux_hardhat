...
/*!
 * TODO: This define should be removed when Virtio updates their implementation
 * IRQSTAT register offset within PBC. IRQSTAT of PBC register will indicate
 * the current state of the Irq(1:0) interrupts.
 */
#define PBC_IRQSTAT             0x000002
/*!
