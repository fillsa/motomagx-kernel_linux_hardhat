...
#ifndef __ASM_ARM_ARCH_BOARD_I30030ADS_H_
#define __ASM_ARM_ARCH_BOARD_I30030ADS_H_
...
#define MAXROW                  8
/*!
 * Maximum number of columns (0 to 3)
 */
#define MAXCOL                  4
/*! @} */
...
#define CS8900A_BASE_ADDRESS    (IO_ADDRESS(CS4_BASE_ADDR) + 0x300)
/*! @} */

#define MXC_PMIC_INT_LINE       INT_EXT_INT1

#endif				/* __ASM_ARM_ARCH_BOARD_I30030ADS_H_ */
