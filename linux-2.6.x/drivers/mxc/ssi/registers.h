 ...
 * Date         Author          Comment
 * ===========  ==============  ==============================================
 * 12-Jan-2006  Motorola        Added SSI interrupt workaround.
 */
...
/**** TODO: Remove this later. This has been added because since Linux2.8.00 FSL version of 
            ssi_interrupt_enable() stopped working *******/

#define ModifyRegister32(a,b,c)	((c) = ( ( (c)&(~(a)) ) | (b) ))

#define DIFF_SSI2_SSI1 (SSI2_BASE_ADDR-SSI1_BASE_ADDR)

#define    _reg_SSI_SIER(a)   (*((volatile unsigned long *) \
                              (IO_ADDRESS( (SSI1_BASE_ADDR+ \
                              (a*DIFF_SSI2_SSI1)) + 0x18))))
/**** END TODO **********/
