 ...
 * for the channnel 0 to be opened and has default values. 
 * For other channels,this function should be called after channel 0 has been opened, 
 * and it is channel descriptor for channel 0.Must be allocated.
