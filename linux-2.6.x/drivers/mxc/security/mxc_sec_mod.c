...
/* Export Symbol of RNGA */
#ifdef CONFIG_MXC_SECURITY_RNGA
EXPORT_SYMBOL(rnga_configure);
EXPORT_SYMBOL(rnga_get_status);
EXPORT_SYMBOL(rnga_get_control);
EXPORT_SYMBOL(rnga_get_mode);
EXPORT_SYMBOL(rnga_get_fifo_level);
EXPORT_SYMBOL(rnga_seed_rand);
EXPORT_SYMBOL(rnga_get_rand);
EXPORT_SYMBOL(rnga_clear_int);
EXPORT_SYMBOL(rnga_get_fifo_size);
EXPORT_SYMBOL(rnga_configure_mode);
EXPORT_SYMBOL(rnga_sleep);
EXPORT_SYMBOL(rnga_config_vrfy_ctrl);
EXPORT_SYMBOL(rnga_config_osc_cntctrl);
EXPORT_SYMBOL(rnga_osc_cnt);
EXPORT_SYMBOL(rnga_osc_status);
EXPORT_SYMBOL(rnga_normal);
#ifdef CONFIG_PM
EXPORT_SYMBOL(rnga_suspend);
EXPORT_SYMBOL(rnga_resume);
#endif
#endif
