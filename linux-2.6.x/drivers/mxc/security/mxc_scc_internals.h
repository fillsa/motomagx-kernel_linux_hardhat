...
static scc_return_t check_register_accessible (uint32_t offset,
                                               uint32_t smn_status,
                                               uint32_t scm_status);
inline static int offset_within_smn(uint32_t offset);
inline static int offset_within_scm(uint32_t offset);
static scc_return_t check_register_offset(uint32_t offset);

inline static scc_return_t verify_slot_access(uint64_t owner_id,
                                              uint32_t slot, uint32_t access_len);
