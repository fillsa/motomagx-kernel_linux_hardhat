...
#define QCIF_OFFSET(x) (((x)==0)?0x00000: 	\
			  ((x)==1)?0x30000: 	\
			  	-1 )

#define CIF_OFFSET(x)  (((x)==0)?0x00000: 	\
			  ((x)==1)?0x60000: 	\
			  	-1 )
...
#define SYNC_ENABLED( conf ) 	( conf & 0x0004)
					       ...
					       /* Display 1 & 2 Write Timing Configuration *//* TODO: split into bit definition */
#define PNX4008_DUM_WT_CFG1		0x00372000
#define PNX4008_DUM_WT_CFG2		0x00372000

					      /* Display 1 & 2 Read Timing COnfiguration *//* TODO: split into bit definition */
#define PNX4008_DUM_RT_CFG1		0x00003A47
#define PNX4008_DUM_RT_CFG2		0x00003A47
