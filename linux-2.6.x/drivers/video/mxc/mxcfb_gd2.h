...
#define GD2_SCREEN_WIDTH		480
#define GD2_SCREEN_HEIGHT		480
#define GD2_SCREEN_LEFT_OFFSET	0
#define GD2_SCREEN_TOP_OFFSET	0
...
// GD2 Epson Round 480x480 display command list
