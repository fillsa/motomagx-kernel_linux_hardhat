...
/*!
 * @file scma11bb_flash.c
 *
 * @brief This file contains the MTD Mapping information on the
 * SCM-A11 reference boards and Ascension, Lido and Saipan.
 *
 * @ingroup NOR_MTD
 */
...
static int __init bb_mtd_init(void)
{
        ...
        bb_map.virt = ioremap(BB_FLASH_BASE_PA, 
                                                    bb_map.size);
