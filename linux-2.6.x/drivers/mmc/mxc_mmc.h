 ...
 * Date         Author                  Comment
 * 05/14/2008   Motorola                Add more selection for the workaround of scma11 clock logic issue
 * 08/08/2008	Motorola		Fix 4bit issue
 */
...
#define STR_STP_CLK_START_CLK           ((1<<1)|(1<<14)|(1<<15))
#define STR_STP_CLK_STOP_CLK            ((1<<0)|(1<<14)|(1<<15))
