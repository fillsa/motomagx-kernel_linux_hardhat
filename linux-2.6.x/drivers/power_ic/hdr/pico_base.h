 ...
 * 02111-1307, USA
 *
 * Motorola 2007-May-23 - Update settings for power consumption
 * Motorola 2007-Apr-23 - Remove Power Control 1 initialization 
 * Motorola 2007-Jan-08 - Updated copyright.
 * Motorola 2006-Nov-30 - Update setting for REG_MODE_0
 * Motorola 2006-Nov-15 - Remove LED register initialization.
 * Motorola 2006-Nov-10 - Update setting for REG_MODE_1
 * Motorola 2006-Sep-14 - Initial Creation
 */

#ifndef __PICO_BASE_H__
#define __PICO_BASE_H__
 ...
 *
 * This file contains all the register values used for the base pico.
 */
...
******************************************************************************/
 ...
 static const unsigned int tab_init_reg_pico_base[NUM_INIT_REGS][NUM_INIT_TABLE_COLUMNS] =
{
    ...
    {POWER_IC_REG_ATLAS_REGEN_ASSIGN,      0x0400000},
    ...
    {POWER_IC_REG_ATLAS_SWITCHERS_5,       0x07A360D},
    {POWER_IC_REG_ATLAS_REG_SET_0,         0x0063FBC},
    {POWER_IC_REG_ATLAS_REG_SET_1,         0x0000E7E},
    {POWER_IC_REG_ATLAS_REG_MODE_0,        0x0E3F1FF},

    {POWER_IC_REG_ATLAS_REG_MODE_1,        0x01DB038},
