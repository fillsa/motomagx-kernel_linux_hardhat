 ...
 * Motorola 2008-Jan-29 - Initial Creation for xPixl based on Marco
 */

#ifndef __XPIXL_BASE_H__
#define __XPIXL_BASE_H__
 ...
 *
 * This file contains all the register values used for the base xpixl.
 */
...
******************************************************************************/
 ...
 static const unsigned int tab_init_reg_xpixl_base[NUM_INIT_REGS][NUM_INIT_TABLE_COLUMNS] =
{
    ...
    {POWER_IC_REG_ATLAS_SWITCHERS_5,       0x03A360D},
