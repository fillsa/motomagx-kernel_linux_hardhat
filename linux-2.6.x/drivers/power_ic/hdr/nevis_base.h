 ...
 * 02111-1307, USA
 *
 * Motorola 2008-Feb-13 - Initial Creation
 */

#ifndef __NEVIS_BASE_H__
#define __NEVIS_BASE_H__
 ...
 *
 * This file contains all the register values used for the base nevis.
 */
...
static const unsigned int tab_init_reg_nevis_base[NUM_INIT_REGS][NUM_INIT_TABLE_COLUMNS] =
{
    ...
    {POWER_IC_REG_ATLAS_SWITCHERS_5,       0x032360D},
    {POWER_IC_REG_ATLAS_REG_SET_0,         0x0063FBC},
    {POWER_IC_REG_ATLAS_REG_SET_1,         0x0000FBF},
    {POWER_IC_REG_ATLAS_REG_MODE_0,        0x0E3807F},

    {POWER_IC_REG_ATLAS_REG_MODE_1,        0x005B001},
