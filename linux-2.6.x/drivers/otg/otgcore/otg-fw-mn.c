...
struct otg_state otg_states_mn[OTG_STATES_MN + 1] = {
	...
	{					 /* 11 */
	 ...
	 0,					 /* .reset */
	 /* .outputs */
	 dp_pullup_out_ | pcd_en_out_ | tcd_en_out_power | dischrg_vbus_out_ | dp_pulldown_out | dm_pulldown_out,
	 },
	{					 /* 12 */
	 peripheral_dropped,			 /* .state */
	 m_b_idle,				 /* .meta */
	...
	{					 /* 13 */
	 ...
	 BUS_RESET_,				 /* .reset */
	 /* .outputs */
	 dp_pullup_out | pcd_en_out | dp_pulldown_out_ | dm_pulldown_out_,
	 },
	{					 /* 14 */
	 peripheral_bus_reset,			 /* .state */
	 m_b_peripheral,			 /* .meta */
	...
	{					 /* 17 */
	 ...
	 0,					 /* .reset */
	 /* .outputs */
	 dp_pullup_out_ | dischrg_vbus_out | pcd_en_out_,
	 },
	{					 /* 18 */
	 peripheral_suspended,			 /* .state */
	 m_b_suspended,				 /* .meta */
