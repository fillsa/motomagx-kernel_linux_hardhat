...
/*****************************************************
 ...
 09-Jun-2008  Motorola       WIFI driver :integrate Marvell pre release (81048p4_26340p77)
 17-Jun-2008  Motorola       WIFI driver :integrate Marvell release (81048p5_26340p78)
*******************************************************/
...
wlan_process_event(wlan_private * priv)
{
    ...
    case MACREG_INT_CODE_IBSS_COALESCED:
        ...
        break;
    case MAC_WATCHDOG_TMOUT_EVENT:
        PRINTM(MSG, "EVENT:WATCHDOG_TMOUT\n");
        break;
    default:
