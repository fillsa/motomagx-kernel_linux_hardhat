...
/*
 * Address offset of ACGSR (CRM_AP module) to enable MU clock gating
 */
#ifdef CONFIG_ARCH_MXC91231
#define CRM_AP_CLOCK			IO_ADDRESS(CRM_AP_BASE_ADDR + 0x18)
#endif

#if defined(CONFIG_ARCH_MXC91331) || defined(CONFIG_ARCH_MXC91321)
#define CRM_AP_CLOCK			IO_ADDRESS(CRM_MCU_BASE_ADDR + 0x024)
#endif
...
/*
 * Bit definitions of ACGSR (CRM_AP module) to enable MU clock gating
 */

#ifdef CONFIG_ARCH_MXC91231
#define MU_CLOCK_OFF			0xFFFFFE3F
#define MU_CLOCK_ON			0x000001C0
#endif

#if defined(CONFIG_ARCH_MXC91331) || defined(CONFIG_ARCH_MXC91321)
#define MU_CLOCK_OFF			0xFFFFFCFF
#define MU_CLOCK_ON			0x00000180
#endif

#ifdef CONFIG_ARCH_MXC91131
#define MU_CLOCK_OFF			0xFFFFFE3F
#define MU_CLOCK_ON			(0x4 << 6)
#endif
