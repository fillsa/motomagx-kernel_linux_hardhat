...
/*
 * DPM (Dynamic Power Management) support for Freescale MXC91321
 *
 ...
 * @file dpm.c
 *
 * @brief This file provides DPM (Dynamic Power Management) support hooks for the Freescale MXC91321
 *
 * @ingroup DPM
 */
 ...
 *
 *  This is a catch-all, simple command processor for the MXC91321 DPM (Dynamic Power Management)
