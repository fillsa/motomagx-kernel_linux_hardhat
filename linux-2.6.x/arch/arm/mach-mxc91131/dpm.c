...
/*
 * DPM support for Freescale MXC91131
 *
 ...
 * @file dpm.c
 *
 * @brief This file provides DPM support hooks for the Freescale MXC91131
 *
 * @ingroup DPM
 */
 ...
 *
 *  This is a catch-all, simple command processor for the MXC91131 DPM
...
{
	printk("Freescale MXC91131 Dynamic Power Management.\n");
