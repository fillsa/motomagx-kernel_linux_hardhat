...
/*
 * DPM (Dynamic Power Management) support for Freescale MXC91131
 *
 ...
 * @file dpm.c
 *
 * @brief This file provides DPM (Dynamic Power Management) support hooks for the Freescale MXC91131
 *
 * @ingroup DPM
 */
 ...
 *
 *  This is a catch-all, simple command processor for the MXC91131 DPM (Dynamic Power Management)
...
{
	printk("Freescale MXC91131 Dynamic Power Management (DPM).\n");
