...
/*
 * DPM support for Freescale MXC91231
 *
 ...
 * @file dpm.c
 *
 * @brief This file provides DPM support hooks for the Freescale MXC91231
 *
 * @ingroup DPM
 */
 ...
 *
 *  This is a catch-all, simple command processor for the MXC91231 DPM
...
{
	printk("Freescale MXC91231 Dynamic Power Management.\n");
